...
#The pretrained weights have been downloaded from:
#https://github.com/rodrigo2019/keras_yolo2/releases
FULL_YOLO_BACKEND_PATH  = "data/pretrained/full_yolo_backend.h5"
TINY_YOLO_BACKEND_PATH  = "data/pretrained/tiny_yolo_backend.h5"
SQUEEZENET_BACKEND_PATH = "data/pretrained/squeezenet_backend.h5"
MOBILENET_BACKEND_PATH  = "data/pretrained/mobilenet_backend.h5"
INCEPTION3_BACKEND_PATH = "data/pretrained/inception_backend.h5"
VGG16_BACKEND_PATH      = "data/pretrained/vgg16_backend.h5"
RESNET50_BACKEND_PATH   = "data/pretrained/resnet50_backend.h5"
...
def get_feature_extractor(backend, input_size):
    ...
    print("Output shape for the feature extractor is: {}".format(feature_extractor.get_output_shape()))
    grid_h, grid_w = feature_extractor.get_output_shape()

    return feature_extractor, grid_h, grid_w
